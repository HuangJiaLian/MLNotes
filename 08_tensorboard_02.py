...
def add_layer(inputs, in_size, out_size, n_layer, actication_function = None):
...
l1 = add_layer(xs, 1, 10, n_layer = 1,actication_function = tf.nn.relu)
prediction = add_layer(l1, 10, 1, n_layer = 2,actication_function = None)
